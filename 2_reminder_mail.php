...
$day2 = "FRI, July 15, 2016 3:00 - 4:00PM IST / 5:30 - 6:30PM SGT / 7:30 - 8:30PM AEST";
...
if ($result->num_rows > 0) {
    ...
    while($row = $result->fetch_assoc()) {
        ...
        $mail->Body = 'Hello'.' '.<b>$row['firstname'].' '.$row['lastname']</b>.','."<br/>"."<br/>"."This is a reminder that Virtual Event introducing OpenStack will begin in 1 Day on:"."<br/>"."<br/>"."<b><font color='blue'>$day2</font></b>"."<br/>"."<br/>"."<img src=\"cid:logoimg\"/>"."<br/>"."<br/>"."<br/>"."<br/>"."<br/>".'Regards,'."<br/>".'<b>OneCloud Consulting Team</b>';
